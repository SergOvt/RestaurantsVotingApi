...
import static ru.voting.api.restaurants.model.Role.ROLE_ADMIN;
import static ru.voting.api.restaurants.model.Role.ROLE_USER;
...
public class TestData {
    ...
    public static final User USER_1 = new User(1, "user1", "user1@mail.ru", "{noop}qwerty", ROLE_USER);
    public static final User USER_2 = new User(2, "user2", "user2@mail.ru", "{noop}qwerty", ROLE_USER);
    public static final User ADMIN = new User(3, "admin", "admin@mail.ru", "{noop}qwerty", ROLE_ADMIN);
    public static final User USER_NEW = new User(null,"new", "new@mail.ru", "{noop}qwerty", ROLE_USER);
