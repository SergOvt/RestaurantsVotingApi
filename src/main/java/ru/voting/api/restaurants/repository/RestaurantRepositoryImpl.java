...
public class RestaurantRepositoryImpl implements RestaurantRepository{
    ...
    @Autowired
    public RestaurantRepositoryImpl(CrudMealRepository crudMealRepository, CrudRestaurantRepository crudRestaurantRepository, CrudVoteRepository crudVoteRepository) {
